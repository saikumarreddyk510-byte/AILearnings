...
#   --> read_uploaded_file() from file_utils.py
#   --> Supports: .txt / .pdf / .docx
#        |
#        v
# [RAG Settings Sidebar]
#   --> chunk_size, chunk_overlap sliders
#        |
#        v
# [Button: "Build Career Coach RAG Index"]
#   --> create_documents()   [rag_engine.py - Stage 1]
#   --> split_documents()    [rag_engine.py - Stage 2]
#   --> build_vectorstore()  [rag_engine.py - Stage 3+4]
#   --> saved in st.session_state.vectorstore
#        |
#        v
# [Question Section]
#   --> Quick questions dropdown / custom text input
#   --> run_career_coach()          [rag_engine.py - Stage 5+6]
#   --> generate_complete_report()  [rag_engine.py - full report]
#        |
#        v
# [Display Answer + Retrieved Context Chunks]
#
# ---------------- Deep Architecture Notes ----------------
# app.py lo Streamlit UI define chesaam — idi user ki visible part.
# file_utils.py ni call chesi uploaded file ni text ga convert chestundi.
# rag_engine.py ni call chesi complete RAG pipeline run chestundi.
# st.session_state use chesi vectorstore session lo store chestundi —
#   page refresh ayina index rebuild cheyyakkarledhu.
# Two modes: quick preset questions + custom question input.
# Retrieved source chunks expander lo show chestundi — transparency ki.
# Chunk size, overlap user adjust cheyyachu sidebar lo — RAG tuning.
